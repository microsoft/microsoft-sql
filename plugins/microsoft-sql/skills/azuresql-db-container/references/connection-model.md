...
SQLCMDPASSWORD="${MSSQL_SA_PASSWORD:?Set and export MSSQL_SA_PASSWORD}" docker exec -e SQLCMDPASSWORD -i sqldb /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -C -b \
