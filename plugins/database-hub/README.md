...
- Claude Code: `/plugin install database-hub@sql-agent-skills` after `/plugin marketplace add <this repository>`
- Copilot CLI: `copilot plugin install database-hub@sql-agent-skills` after `copilot plugin marketplace add <this repository>`, or `copilot --plugin-dir <path to this directory>`
