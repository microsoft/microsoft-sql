...
The response file is supplied through shell process substitution, keeping the
password out of the SqlPackage process arguments and off persistent storage.
