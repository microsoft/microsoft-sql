...
initialize (see `troubleshooting.md`). Set and export a private value before
running a recipe; these docs do not provide a default.
...
```bash
# Template: replace <MSSQL_SA_PASSWORD> from your secret source before use.
