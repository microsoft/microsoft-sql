# SQL Server to Azure migration (`sql-migration`) 1.1.0
...
- Claude Code: `/plugin install sql-migration@sql-agent-skills` after `/plugin marketplace add <this repository>`
- Copilot CLI: `copilot plugin install sql-migration@sql-agent-skills` after `copilot plugin marketplace add <this repository>`, or `copilot --plugin-dir <path to this directory>`
