...
not have. Please search the [existing issues](https://github.com/microsoft/microsoft-sql/issues)
before filing, to avoid duplicates.

Open a new issue with the **Agent skill feedback** form:
[github.com/microsoft/microsoft-sql/issues/new?template=skill_feedback.yml](https://github.com/microsoft/microsoft-sql/issues/new?template=skill_feedback.yml).
...
[Discussions](https://github.com/microsoft/microsoft-sql/discussions).
