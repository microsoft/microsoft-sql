...
**56 skills** are installed by the commands above. Expand a group to see what each one does.
...
A further 86 skills are planned. The full list, with the domain and intent of each, is in [catalog/catalog.json](catalog/catalog.json).
